...
from clauderfall_v1.persistence.models import ArtifactTraceLinkRecord, Base
from clauderfall_v1.persistence.repositories import SqlAlchemyArtifactIndexRepository, SqlAlchemyDesignArtifactRepository
