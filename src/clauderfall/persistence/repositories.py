...
from clauderfall.artifacts.common import ArtifactKind, ArtifactVersionRef, TraceLinkMatch
...
from clauderfall.persistence.models import ArtifactRecord, ArtifactTraceLinkRecord
